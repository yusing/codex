...
impl CollaborationModeIndicator {
    fn label(self, show_cycle_hint: bool) -> String {
        ...
        match self {
            ...
            CollaborationModeIndicator::Orchestrated => format!("Orchestrated mode{suffix}"),
    ...
    fn styled_span(self, show_cycle_hint: bool) -> Span<'static> {
        ...
        match self {
            ...
            CollaborationModeIndicator::Orchestrated => Span::from(label).cyan(),
...
mod tests {
    ...
    fn footer_snapshots() {
        ...
        snapshot_footer_with_mode_indicator(
            "footer_orchestrated_mode_indicator_wide",
            /*width*/ 120,
            &props,
            Some(CollaborationModeIndicator::Orchestrated),
        );
